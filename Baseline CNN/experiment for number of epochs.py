...
history = model.fit(train_images, train_labels, validation_data=(val_images, val_labels), batch_size=32, epochs=train_epochs, verbose=1, callbacks=[es])



_, train_acc = model.evaluate(train_images, train_labels, verbose=2)
_, val_acc = model.evaluate(val_images, val_labels, verbose=2)
