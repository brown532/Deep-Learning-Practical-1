...
print("\n\nModel 0:")
VGG_model = standard_CNN_Model(activation='relu')
...
VGG_model = standard_CNN_Model(drop_out=True,activation='relu')
print("\n\nModel 1:")
# #train model on training set
VGG_model.fit(train_images, train_labels, batch_size=32, epochs=train_epochs,verbose=1)
test_loss, test_acc = VGG_model.evaluate(test_images, test_labels,verbose=2)
...
VGG_model = standard_CNN_Model(drop_out=True,weight_decay=True,activation='relu')
print("\n\nModel 2:")
# #train model on training set
VGG_model.fit(train_images, train_labels, batch_size=32, epochs=train_epochs,verbose=1)
test_loss, test_acc = VGG_model.evaluate(test_images, test_labels,verbose=2)
...
VGG_model = standard_CNN_Model(drop_out=True,weight_decay=True,batch_normalization=True,activation='relu')
print("\n\nModel 3:")
# #train model on training set
VGG_model.fit(train_images, train_labels, batch_size=32, epochs=train_epochs,verbose=1)
test_loss, test_acc = VGG_model.evaluate(test_images, test_labels,verbose=2)
...
VGG_model = standard_CNN_Model(drop_out=True,weight_decay=True,batch_normalization=True,activation='lrelu')
print("\n\nModel 4:")
# #train model on training set
VGG_model.fit(train_images, train_labels, batch_size=32, epochs=train_epochs,verbose=1)
test_loss, test_acc = VGG_model.evaluate(test_images, test_labels,verbose=2)
...
VGG_model = standard_CNN_Model(drop_out=True,weight_decay=True,batch_normalization=True,activation='sigmoid')
print("\n\nModel 5:")
# #train model on training set
VGG_model.fit(train_images, train_labels, batch_size=32, epochs=train_epochs,verbose=1)
test_loss, test_acc = VGG_model.evaluate(test_images, test_labels,verbose=2)
...
VGG_model = standard_CNN_Model(drop_out=True,weight_decay=True,batch_normalization=True,activation='relu',optimizer='sgd')
print("\n\nModel 6:")
# #train model on training set
VGG_model.fit(train_images, train_labels, batch_size=32, epochs=train_epochs,verbose=1)
test_loss, test_acc = VGG_model.evaluate(test_images, test_labels,verbose=2)
...
VGG_model = standard_CNN_Model(drop_out=True,weight_decay=True,batch_normalization=True,activation='relu',optimizer='sgd with momentum')
print("\n\nModel 7:")
# #train model on training set
VGG_model.fit(train_images, train_labels, batch_size=32, epochs=train_epochs,verbose=1)
test_loss, test_acc = VGG_model.evaluate(test_images, test_labels,verbose=2)
